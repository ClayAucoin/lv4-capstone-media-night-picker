// src/routes/read.js
// NOT ACTIVE - MOVED BACK TO port 3105
...
// moved back to 
router.post('/ai-old', validateAIAPIKey, requestId, validateMoodBucket, validateLengthBucket, validateWxBucket, async (req, res, next) => {
