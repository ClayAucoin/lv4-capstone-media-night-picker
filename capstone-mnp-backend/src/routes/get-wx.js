...
router.post("/wx", requestId, validateWxAPIKey, validateWeatherVars, async (req, res, next) => {
  ...
  baseUrl = "http://localhost:3100/api/v1/wx"

  // baseUrl = "http://localhost:3100/api/v1/weather"
  // }
  req.log.info({ req_id: req_id, route: "/wx", file: "get-wx.js", baseUrl: baseUrl, step: "bk-wx: baseUrl" }, "URL")

  const { zip, dateString } = req.weatherParams
  req.log.info({ req_id: req_id, route: "/wx", file: "get-wx.js", req_weatherParams: req.weatherParams, step: "bk-wx: req.weatherParams" }, "parameters")
  ...
  try {
    ...
    console.log("POST /wx")
    req.log.info({ req_id: req_id, route: "/wx", file: "get-wx.js", data: data, step: "bk-wx: data from response" }, "fetch response")
    ...
    req.log.info({ req_id: req_id, route: "/wx", file: "get-wx.js", sendData: sendData, step: "bk-wx: sendData" }, "sendData")
