...
router.post("/submit", validateAPIKey, requestId, async (req, res, next) => {
  ...
  // get wx condition
  req.log.info({ req_id: REQ_ID, route: "/submit", file: "read-submit.js", wxPayload: wxPayload, step: "b4 getWxCondition success response" }, "wxPayload")
  ...
  req.log.info({ req_id: REQ_ID, route: "/submit", file: "read-submit.js", query_string: QUERY_SIG, step: "bk-core: query_signature, before query_signature_ck" }, "query_signature")
  ...
  req.log.info({ req_id: REQ_ID, route: "/submit", file: "read-submit.js", ck_qs: ck_qs, step: "bk-core: ck_qs, query_signature_ck response" }, "query_signature_ck")
  ...
  if (ck_qs.length === 0) {
    ...
    req.log.info({ req_id: REQ_ID, route: "/submit", file: "read-submit.js", addPayload: addPayload, step: "bk-core: addPayload, before addAiSuggestions" }, "addPayload")
